...
def greet(name, age): #こっちは：という点と全部につくわけではない点に注意
    return f"こんにちは、{name}さん！{age}歳！" #現状はまだこんにちは、を変更
...
class Person:
 ...
 #__init__については初期設定にするとなっていたが、そもそもここでいるのかと、＿＿を用いたものは複数あると判明した為一度まとめたのち該当のもので実験する必要あり
...
#現状までの要素を用いて一度何か簡単なものを作成してみるのが望ましいと判断